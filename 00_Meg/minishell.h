...
/*   Updated: 2025/07/17 20:17:42 by gapujol-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		delimiter_found(int *in_t, char **input, char **start, t_token **head);

//tokenizer_input.c
int		parse_input(char **input, t_token **head, int *in_token, char **start);
...
//update_token.c
int		update_token(t_token **lst, char *str, char *pos, t_token_type type);
...
int		parse_type_var_util(char *var, t_files *env, t_token **t, t_token **l);
...
//exec_builtins
int		exec_builtin(t_cmd *cmds, t_cmd *cmd, t_files **env, int exit_status);
int		exec_builtin_no_output(t_cmd *cmds, t_cmd *cmd, t_files **env, int s);
