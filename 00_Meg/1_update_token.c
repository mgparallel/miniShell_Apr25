...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/07 06:21:35 by menwu             #+#    #+#             */
/*   Updated: 2025/07/07 06:22:30 by menwu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

void	update_token_util(t_token **current_token, t_token **quote_token,
		char *first_value, t_token_type type)
{
	(*current_token)->value = first_value;
	(*quote_token)->type = type;
	(*quote_token)->has_leading_space = 0;
	(*quote_token)->in_quote = (*current_token)->in_quote;
